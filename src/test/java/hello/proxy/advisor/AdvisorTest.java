...
public class AdvisorTest {
    ...
    void advisorTest1() {
        ...
        proxyFactory.addAdvisor(new DefaultPointcutAdvisor(Pointcut.TRUE, new TimeAdvice()));   // ProxyFactory 사용시 Advisor는 필수라고 할 수 있다.
        // proxyFactory.addAdvice(new TimeAdvice());와 같은 기능
